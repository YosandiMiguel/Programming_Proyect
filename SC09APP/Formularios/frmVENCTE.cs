...
namespace SC09APP
{
    public partial class frmVENCTE : Form
    {
        ...
        private void BuscarDatos()
        {
            ...
            SqlCommand sqCmd = new SqlCommand("SELECT IDCLIENTE, NOMBRE "
                                            + "  FROM CLIENTES "
            ...
            try
            {
                ...
                {  // no es fin de archivo true false
                    ...
                    dgv[0, xRows].Value = Convert.ToString(recordset["IDCLIENTE"]);         // escribe en la grilla, en la celda 0 y en la fila (x), el contenido del campo IDDEPARTAMENTO     de la tabla DEPARTAMENTO
                    dgv[1, xRows].Value = Convert.ToString(recordset["NOMBRE"]);   // escribe en la grilla, en la celda 1 y en la fila (x), el contenido del campo NOMBREDEPARTAMENTO de la tabla DEPARTAMENTO
                }
            }
            catch
            {
