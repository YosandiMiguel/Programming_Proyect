...
namespace SC09APP
{
    ...
    {
        public string _varf1; // variable publica usada para transportar la data elegida al dar doble click en la grilla
        public string _varf2; // variable publica usada para transportar la data elegida al dar doble click en la grilla
        ...
        private void Estilodgv()
        {
            ...
            this.dgv.Columns.Add("Col00", "POSICION");
            this.dgv.Columns.Add("Col01", "PUESTO");
        ...
        private void btnSeleccionar_Click(object sender, EventArgs e)
        {
            //try
            //{ //Data grid View 
                _varf1 = dgv.CurrentRow.Cells[0].Value.ToString();  // selecciona el valor contenido en la celda actual de la columna 0 de la fila seleccionada
                _varf2 = dgv.CurrentRow.Cells[1].Value.ToString();  // selecciona el valor contenido en la celda actual de la columna 1 de la fila seleccionada
        ...
        private void BuscarDatos()
        {
            ...
            SqlCommand sqCmd = new SqlCommand("SELECT IDPOSICION, NOMBREDEPOSICION "
                                            + "  FROM POSICIONES "
